<template>
  <div class="container mt-4">
    ...
    <div v-if="!accountStore.isLogin" class="p-5 mb-5 bg-light rounded-3 shadow-sm text-center">
      ...
      <h1 class="display-6 fw-bold mb-3">어디 도서관에 내 취향 '책잇다'</h1>
      <p class="text-muted mb-4">로그인하면 근처 도서관에서 <strong>지금 빌릴 수 있는</strong> 책을 취향에 맞춰 추천해 드려요.</p>
    ...
    <div class="p-5 mb-5 bg-light rounded-3 shadow-sm">
      <div class="container-fluid">
        ...
        <div v-else-if="recommendStore.isLoaded && recommendStore.recommendations.length > 0">
          <div v-for="item in recommendStore.recommendations" :key="item.isbn13" class="card mb-3 border-0 shadow-sm overflow-hidden h-100">
