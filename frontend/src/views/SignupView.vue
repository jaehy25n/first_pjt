  ...
  <div class="container d-flex justify-content-center align-items-center" style="min-height: 70vh;">
    <div class="card shadow-lg border-0 rounded-4" style="max-width: 400px; width: 100%;">
      <div class="card-body p-5">
        <h2 class="text-center mb-4 fw-bold text-primary logo-gradient">회원가입</h2>
        <form @submit.prevent="handleSignup">
          ...
          <div class="mb-3">
            <label for="passwordConfirm" class="form-label text-secondary">비밀번호 확인</label>
            <input 
              type="password" 
              class="form-control form-control-lg bg-light border-0" 
              id="passwordConfirm" 
          ...
          <div class="mb-4">
            <label for="email" class="form-label text-secondary">이메일 (선택)</label>
            <input 
              type="email" 
              class="form-control form-control-lg bg-light border-0" 
              id="email" 
        ...
        <div class="text-center mt-4 pt-3 border-top">
          ...
          <router-link :to="{ name: 'login' }" class="text-decoration-none fw-bold">로그인하기</router-link>
        </div>
      </div>
    </div>
  </div>
